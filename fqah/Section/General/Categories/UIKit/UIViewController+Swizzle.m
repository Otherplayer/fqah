...
//        SEL swizzledSelector = @selector(fqah_viewWillAppear:);
//        
...
//    });
    ...
    NSError *error = nil;
    [self jr_swizzleMethod:@selector(viewWillAppear:) withMethod:@selector(fqah_viewWillAppear:) error:&error];
    if (error) {
...
- (void)fqah_viewWillAppear:(BOOL)animated {
    [self fqah_viewWillAppear:animated];
